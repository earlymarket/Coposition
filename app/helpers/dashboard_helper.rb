module DashboardHelper
  ...
  def dashboard_country_name(code)
    iso_countries.fetch(code.upcase.to_sym, code)
  end

  def dashboard_flag(code)
    no_flag = ["AX", "AS", "AI", "AQ", "AW", "BM", "BV", "IO", "KY", "CX", "CC", "CK",
    "FK", "FO", "GF", "PF", "TF", "GI", "GL", "GP", "GU", "GG", "HM", "IM", "JE", "MO",
    "MQ", "YT", "MS", "AN", "NC", "NU", "NF", "MP", "PS", "PN", "PR", "RE", "BL", "SH",
    "MF", "PM", "GS", "SJ", "TK", "TC", "UM", "VG", "VI", "WF"]
